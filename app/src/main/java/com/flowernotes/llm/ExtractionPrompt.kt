...
object ExtractionPrompt {
    ...
    fun build(testo: String): String {
        ...
        return """
            ...
            {"titolo": "...", "data": "YYYY-MM-DD", "ora": "HH:MM", "durata_minuti": 60, "reminder_minuti": 30, "luogo": ""}
            Regole:
            ...
            - durata_minuti: 60 se non specificata.
            - reminder_minuti: 30 se non specificato; se l'utente chiede un promemoria esplicito usa quello.
